<x-layout>
    <div class="mx-auto max-w-3xl px-6 py-12 sm:py-24">
        ...
        <div class="mt-12 space-y-6 reveal d3">
            ...
            <a href="{{ $project['github_url'] }}" target="_blank" class="block rounded-3xl bg-gray-50 border border-gray-100 p-6 sm:p-8 transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-gray-200/50 group">
