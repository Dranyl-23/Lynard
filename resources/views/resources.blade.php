    ...
    <div class="mx-auto max-w-4xl px-6">
        ...
        <section class="relative pt-20 pb-12 sm:pt-28 border-b border-gray-100/0">
            ...
            <p class="mt-4 max-w-lg text-[0.95rem] leading-relaxed text-gray-700 sm:mt-5 sm:text-base">
                A hand-picked list of the resources I keep coming back to — for learning to build software, getting into AI engineering, and staying current. Free or freemium, and genuinely worth your time.
            </p>
        </section>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                        <a href="https://www.deeplearning.ai/" target="_blank" class="group flex flex-col">
                            ...
                            <p class="text-[12.5px] text-gray-500 mt-1 leading-relaxed">
